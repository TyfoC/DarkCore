...
%DEFINE THREAD_OFFSET_SLEEP_TICKS_COUNT						4
%DEFINE THREAD_OFFSET_TICKS_BEFORE_SWITCH_COUNT				8
%DEFINE THREAD_OFFSET_WORKED_TICKS_COUNT					12
%DEFINE THREAD_OFFSET_PAGING_DIRECTORY						16
%DEFINE THREAD_OFFSET_REGISTER_GS							20
%DEFINE THREAD_OFFSET_REGISTER_FS							24
%DEFINE THREAD_OFFSET_REGISTER_ES							28
%DEFINE THREAD_OFFSET_REGISTER_DS							32
%DEFINE THREAD_OFFSET_REGISTER_DI							36
%DEFINE THREAD_OFFSET_REGISTER_SI							40
%DEFINE THREAD_OFFSET_REGISTER_BP							44
%DEFINE THREAD_OFFSET_REGISTER_SP							48
%DEFINE THREAD_OFFSET_REGISTER_BASE							52
%DEFINE THREAD_OFFSET_REGISTER_DATA							56
%DEFINE THREAD_OFFSET_REGISTER_COUNTER						60
%DEFINE THREAD_OFFSET_REGISTER_ACCUMULATOR					64
%DEFINE THREAD_OFFSET_REGISTER_IP							68
%DEFINE THREAD_OFFSET_REGISTER_CS							72
%DEFINE THREAD_OFFSET_REGISTER_FLAGS						76
%DEFINE THREAD_OFFSET_NEXT									80
%DEFINE THREAD_OFFSET_CURRENT_PATH_STRING_VIRTUAL_ADDRESS	84
...
Schedule:
	...
	INC DWORD [EAX + THREAD_OFFSET_WORKED_TICKS_COUNT]
	CMP DWORD [EAX + THREAD_OFFSET_TICKS_BEFORE_SWITCH_COUNT], 0
	...
	MOV DWORD [EAX + THREAD_OFFSET_TICKS_BEFORE_SWITCH_COUNT], 100
	...
	JMP ScheduleDone
ScheduleNotSwitched:
	DEC DWORD [EAX + THREAD_OFFSET_TICKS_BEFORE_SWITCH_COUNT]
ScheduleDone:
	MOV AL, 0x20
	OUT 0x20, AL
